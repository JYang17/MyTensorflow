    ...
    with arg_scope(
      ...
      with arg_scope(
        ...
        net = layers_lib.dropout(
		    ...
		    #change net to net 0,1,2,3 to adopt multi-task learning
        #最好是用vscode编辑Python code，用notepad++可能有对齐问题
        net0 = layers.conv2d(
            net,
            num_classes, [1, 1],
            activation_fn=None,
      ...
      if spatial_squeeze:
        net0 = array_ops.squeeze(net, [1, 2], name='fc8_0/squeezed')
        end_points[sc.name + '/fc8_0'] = net0
        net1 = array_ops.squeeze(net, [1, 2], name='fc8_1/squeezed')
        end_points[sc.name + '/fc8_1'] = net1
        net2 = array_ops.squeeze(net, [1, 2], name='fc8_2/squeezed')
        end_points[sc.name + '/fc8_2'] = net2
        net3 = array_ops.squeeze(net, [1, 2], name='fc8_3/squeezed')
