# https://www.bilibili.com/video/av20034351/index_34.html#page=35
#https://www.jianshu.com/p/bc2852978010
#https://blog.csdn.net/FANGPINLEI/article/details/52200832?locationNum=1&fps=1
...
#下载数据集
def maybe_download(filename,expacted_bytes):
    if not os.path.exists(filename):
        filename,_ = urllib.request.urlretrieve(url + filename, filename)
    #获取文件相关属性
    statinfo = os.stat(filename)
    #比对文件相关属性
    if statinfo.st_size == expacted_bytes:
...
try:
    from sklearn.manifold import TSNE # pylint: disable=g-import-not-at-top
