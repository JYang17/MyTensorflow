# https://www.bilibili.com/video/av20034351/?p=24
#based on 4-1
#https://www.bilibili.com/video/av20034351/?p=10
#不使用卷积神经网络的MNIST
...
with tf.Session() as sess:
    ...
    for step in range(21):#总共数据反复训练21次
        ...
        restore_acc = sess.run(accuracy,feed_dict={x:mnist.test.images,y:mnist.test.labels})
        print("Step:"+str(step)+" restored model accuracy:"+str(restore_acc))
